...
namespace TunifyPlatform.Migrations
{
    ...
    [Migration("20240822162531_identity")]
            ...
            modelBuilder.Entity("TunifyPlatform.Models.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            JoinDate = new DateTime(2024, 8, 22, 19, 25, 31, 471, DateTimeKind.Local).AddTicks(2887),
                            SubscriptionId = 1,
                            Username = "admin"
                        },
                        new
                        {
                            ...
                            JoinDate = new DateTime(2024, 8, 12, 19, 25, 31, 471, DateTimeKind.Local).AddTicks(2905),
                            SubscriptionId = 1,
                            Username = "user1"
                        },
                        new
                        {
                            ...
                            JoinDate = new DateTime(2024, 8, 2, 19, 25, 31, 471, DateTimeKind.Local).AddTicks(2916),
                            SubscriptionId = 2,
                            Username = "user2"
                        },
                        new
                        {
                            ...
                            JoinDate = new DateTime(2024, 7, 23, 19, 25, 31, 471, DateTimeKind.Local).AddTicks(2919),
                            SubscriptionId = 2,
                            Username = "user3"
                        },
                        new
                        {
                            ...
                            JoinDate = new DateTime(2024, 7, 13, 19, 25, 31, 471, DateTimeKind.Local).AddTicks(2922),
                            SubscriptionId = 1,
                            Username = "user4"
                        });
                });
